        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    charges_name = table.Column<string>(type: "varchar(max)", unicode: false, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    announcement = table.Column<string>(type: "varchar(max)", unicode: false, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Table_Classes",
                        column: x => x.class_id,
                        principalTable: "Classes",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Table_Sessions",
                        column: x => x.session_id,
                        principalTable: "Sessions",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Table_Students",
            ...
            migrationBuilder.CreateTable(
                name: "Challan_Charges_Allocation",
                columns: table => new
                {
                    id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    challan_id = table.Column<int>(type: "int", nullable: false),
                    charges_id = table.Column<int>(type: "int", nullable: false),
                    amount = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Challan_Charges_Allocation", x => x.id);
                    table.ForeignKey(
                        name: "FK_Challan_Charges_Alocation_Charges",
                        column: x => x.charges_id,
                        principalTable: "Charges",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Challan_Charges_Alocation_Fee_Challan",
                        column: x => x.challan_id,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Challan_Charges_Allocation_challan_id",
                table: "Challan_Charges_Allocation",
                column: "challan_id");

            migrationBuilder.CreateIndex(
                name: "IX_Challan_Charges_Allocation_charges_id",
                table: "Challan_Charges_Allocation",
                column: "charges_id");
